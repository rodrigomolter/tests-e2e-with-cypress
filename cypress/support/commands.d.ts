...
declare namespace Cypress {
  interface Chainable {
     ...
     * @example cy.gui_Login('user@email.com', 'S3cRe7P@ssW0rd') // Logs into the app using the provided credentials
     */
    gui_login(username?: string, password?: string): void | Cypress.Chainable<null>
     ...
     */
    gui_createNote(note: string, attachFile?: boolean): Cypress.Chainable<undefined>
     ...
     */
    gui_editNote(note: string, newNoteValue: string, attachFile?: boolean): Cypress.Chainable<undefined>
     ...
     */
    gui_deleteNote(note: string): Cypress.Chainable<undefined>
     ...
     */
    gui_fillSettingsFormAndSubmit(): Cypress.Chainable<JQuery<HTMLButtonElement>>
     ...
     */
    gui_fillSignupFormAndSubmit(email: string, password: string): Cypress.Chainable<JQuery<HTMLElement>>

        /**
     * Logs you off the application using the interface
     *
     * @example gui_logout()
     */
        gui_logout(): Cypress.Chainable<JQuery<HTMLElement>>
  }
}
